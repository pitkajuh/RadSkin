...
fn main() {
    ...
    let cs_137=RadioNuclide{name: String::from("Cs-137"), half_life: HALF_LIFE};
    let ba_137m=RadioNuclide{name: String::from("Ba-137m"), half_life: 2.6};
    ...
    let decay1=BetaDecay{probability: 0.054, parent: &parent1, daughter: &daughter1};
    let decay2=BetaDecay{probability: 0.946, parent: &parent1, daughter: &daughter1};
